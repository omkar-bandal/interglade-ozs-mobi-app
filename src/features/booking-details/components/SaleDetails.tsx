...
const SaleDetails = ({saleId}: {saleId: string}) => {
  ...
  // Format price
  const formattedPrice = saleData?.price ? `$${saleData.price}` : '$100';
    ...
    <View style={styles.container}>
        ...
        <View style={styles.detailContainer}>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.providerContainer}>
              <Image
                source={{uri: saleData?.provider?.profile_picture_url}}
                style={styles.providerImage}
              />
              <Text
                style={
                  styles.providerName
                }>{`${saleData?.provider?.first_name} ${saleData?.provider?.last_name}`}</Text>
            </View>
          </View>
      ...
      <ActionSheet
        ...
        <TimeSlotPicker
          ...
          availableDays={saleData?.availability}
        />
